...
import {Box, rem, BoxProps, ElementProps, Group, ActionIcon} from '@mantine/core';

interface DevIconProps extends BoxProps, ElementProps<'svg', 'display' | 'opacity'> {
    size?: number;
}

export default function GitHubIcon({size = 28, style, ...others}: DevIconProps) {
    return (
        <Group justify='center'>
            <ActionIcon
                component='a'
                href='https://github.com/bluolightning/shoujin'
